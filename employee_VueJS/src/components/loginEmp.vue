        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <form @submit.prevent="login">
                    ...
                    <!--                 error message-->
                    <div class="alert alert-danger" name="alert" v-bind:style="{ display }">{{ error }}</div>

                    <div class="alert alert-info" name="alert" v-bind:style="{ display1 }">{{ message }}</div>


                    <div class="form-group">
                        <label for="email"> Email </label> :
                        <input type="text" class="form-control" id="email" name="email" required v-model="Employee.email_id"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3 mt-4" >
